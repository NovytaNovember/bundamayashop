...
class Kegiatan_kepala_sekolah extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('kepala_sekolah/kegiatan/kegiatan', $data);
    }
    ...
    public function tambah()
    {
        ...
        return view('kepala_sekolah/kegiatan/form_tambah_kegiatan', $data);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('kepala_sekolah/kegiatan/form_edit_kegiatan', $data);
    }
