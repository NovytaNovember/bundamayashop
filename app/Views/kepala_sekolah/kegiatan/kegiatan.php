    ...
    <div class="content">
        <div class="container-fluid">
            <div class="table-container">
                <a class="btn btn-green" href="<?= base_url('tambah_kegiatan_kepsek'); ?>">Tambah</a>
                    ...
                    <?php foreach ($kegiatan as $row) : ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('edit_kegiatan_kepsek/' . $row['id_kegiatan']) ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                    <!-- <a id="hapus" href="<?= base_url('hapus_kegiatan_kepsek/' . $row['id_kegiatan']) ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus</a> -->
                ...
                <script>
                    ...
                    deleteButton.addEventListener('click', function(event) {
                        ...
                        if (confirmResponse) {
                            window.location.href = '<?= base_url('hapus_kegiatan_kepsek/') ?>' + idkegiatan;
                        } else {
                            console.log('halo')
                        }
                    })
